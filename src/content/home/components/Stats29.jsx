        ...
        <div className="mb-12 grid grid-cols-1 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 lg:mb-20 lg:gap-x-20">
          ...
          <div>
            <p className="md:text-md">
              Our clients see real growth. Traffic climbs. Rankings improve.
              Conversions follow. These aren't promises. They're what happens
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Fragment>
            <div className="border border-border-primary p-8 first:flex first:flex-col first:md:col-span-2 first:md:row-span-1 first:lg:col-span-1 first:lg:row-span-2">
              ...
              <p className="mt-2">Within the first year of engagement</p>
            </div>
          </Fragment>
          <Fragment>
            <div>
