        ...
        <div className="mb-12 text-center md:mb-18 lg:mb-20">
          <div className="w-full max-w-lg">
            ...
            <p className="md:text-md">
              Our most impactful pieces, selected for immediate impact.
            </p>
          </div>
        </div>
          ...
          <div className="md:min-w- mb-10">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="category-one">Technical SEO</SelectItem>
                <SelectItem value="category-two">On-page SEO</SelectItem>
                <SelectItem value="category-three">Link building</SelectItem>
                <SelectItem value="category-four">Local SEO</SelectItem>
              </SelectContent>
            </Select>
          </div>
              ...
              <div className="grid grid-cols-1 gap-x-12 gap-y-12 md:gap-y-16">
                  ...
                  <div className="px-5 py-6 md:px-6">
                    ...
                    <a href="#" className="mb-2 block max-w-full">
                      <h5 className="text-2xl font-bold md:text-4xl">
                        Core Web Vitals and ranking impact explained
                      </h5>
                    </a>
                    <p>
                      Learn how page speed and user experience signals directly
                      influence your search visibility.
                    </p>
                    <Button
                      variant="link"
                      size="link"
                ...
                <div className="flex flex-col border border-border-primary">
                  ...
                  <div className="px-5 py-6 md:px-6">
                    ...
                    <p>
                      Small optimizations that drive clicks. See how strategic
                      copywriting boosts CTR from search results.
                    </p>
                    <Button
                      variant="link"
                      size="link"
                ...
                <div className="flex flex-col border border-border-primary">
                  ...
                  <div className="px-5 py-6 md:px-6">
                    ...
                    <p>
                      Discover how quality backlinks from relevant sources
                      establish domain authority and trust.
                    </p>
                    <Button
                      variant="link"
                      size="link"
